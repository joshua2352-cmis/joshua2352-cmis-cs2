...
def ROLL1():
	...
	if roll > 3:
		print 'you have rolled a' +roll+ ' you slay the knight in one blow after rolling away from his attack' 
	elif roll !< 3: 
		print' you have rolled a' +roll+ ' you try to dodge but end up getting hit YOU DIED'
